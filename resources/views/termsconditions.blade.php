            ...
            <section class="section">
                <div class="container-fluid py-4 mb-4 mt-4">
                    <div class="three-fourths columns medium-down--one-whole offset-by-two is-hidden-offset-mobile-only page">
                        ...
                        <P class="terms_p">Nuestros productos serán entregados a través de Chilexpress, Starken, BluExpress o 99Minutos dependiendo de la dirección de envío.
                            El plazo de entrega en región metropolitana y en todo el país es de hasta 5 días hábiles.
                            <br>
                            <br>
                            Para Eventos Especiales como Cyber Day, el plazo puede extenderse a un máximo de 15 días hábiles. El tiempo final de despacho está sujeto
                            ...
                            ", el plazo estará sujeto a los tiempos de distribución y servicio de las empresas de courier antes mencionadas, así como a las limitaciones
                            ...
                            <br>
                            <br>
                            En caso de solicitar la opción de retiro en sucursal Chilexpress o Starken es de responsabilidad del cliente retirar el pedido antes de cumplidos 14
                            días en sucursal. De lo contrario el envío se devolverá a nuestra bodega y el cliente deberá pagar los costos de envío asociados.
                        </p>
                        <p>
                            <span class="terms_p">
                        ...
                        <P class="terms_p">Para cumplir los objetivos de seguridad Que Guay! cuenta con la tecnología SSL (Secure Sockets Layer) que asegura, tanto la autenticidad del Sitio,
                            ...
                            (lo cual se aprecia con la aparición del código HTTPS en la barra de direcciones del navegador). De esta forma se establece un método de
                            cifrado de la información entregada por el usuario y una clave de sesión única. Esta tecnología permite que la información de carácter personal
                            del usuario, como su nombre, dirección y datos de tarjetas bancarias, sean codificadas antes para que no pueda ser leída cuando viaja a través de
                            Internet. Todos los certificados SSL se crean para un servidor particular, en un dominio específico y para una entidad comercial comprobada. </P>
