                ...
                <div class="collapse card d-lg-block mb-5" id="navbarSupportedContent">
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input category-checkbox" type="checkbox" value="{{ $producto->categoria->nombre }}" id="categoryCheckbox{{ $loop->index }}" checked>
                                                <label class="form-check-label" for="categoryCheckbox{{ $loop->index }}">{{ $producto->categoria->nombre }}</label>
                                            </div>
                                        </li>
                            ...
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo">
                                <div class="accordion-body">
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" id="flexCheck{{ $loop->iteration }}" checked />
                                            <label class="form-check-label" for="flexCheck{{ $loop->iteration }}">{{ $producto->marca->nombre }}</label>
                                            <span class="badge badge-secondary float-end">{{ $producto->marca->products->count() }}</span>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <div class="form-outline">
                                                ...
                                                <label class="form-label" for="typeNumber">${{ $productos->min('precio') }}</label>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <p class="mb-0">
                                            ...
                                            <div class="form-outline">
                                                <input type="number" id="typeNumber" class="form-control" />
                                                <label class="form-label" for="typeNumber">${{ $productos->max('precio') }}</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse show" aria-labelledby="headingThree">
                                <div class="accordion-body">
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" id="flexCheck{{ $loop->iteration }}" checked />
                                            <label class="form-check-label" for="flexCheck{{ $loop->iteration }}">{{ $producto->talla }}</label>
                            ...
                            <button type="button" class="btn btn-white w-100 border border-secondary " style="background-color: #8c0343; color: white;">Filtrar</button>
                        </div>
                ...
                <div class="col-lg-12 col-lg-6">
                    <div class="row justify-content-center">
                        <div class="col justify-content-center">
                            <div class="product-grid d-flex justify-content-center" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }' id="productContainer">
                                @foreach ($productos as $index => $producto)
                                <div class="product-item {{ $producto->stock === 0 ? 'out-of-stock' : '' }}" data-category="{{ $producto->categoria->nombre }}" data-brand="{{ $producto->marca->nombre }}" data-size="{{ $producto->talla }}">
                                    <a href="{{ route('product.show', $producto->id) }}">
                                        ...
                                        <form action="{{ route('like-product') }}" method="post">
                                            ...
                                            <button class="btn btn_darlike  {{ Auth::user()->product_desired->contains('product_id', $producto->id) === true ? 'isLike' : '' }}" type="submit">
