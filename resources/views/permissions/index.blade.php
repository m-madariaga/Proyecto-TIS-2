...
@section('breadcrumb')
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Permisos</li>
    </ol>
            ...
            <div class="col-12">
                <div class="card mb-4 ps-3 pe-3 pt-2">
                    <div class="card-header pb-0">
                        <h6>Tabla de Permisos</h6>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <a href="{{ route('permissions.create') }}" class="btn btn-sm btn-outline-success mb-2">Agregar</a>
                        <div class="table-responsive p-0">
                            <table id="permissions-table" class="table display table-stripped align-items-center">
                                <thead>
                                    <tr>
