                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="view-order button_edit_profile btn btn-sm btn-rounded ms-2 mx-2 me-auto" data-order-id="{{ $order->id }}">Ver Pedido</button>
                                        ...
                                        <a href="{{ route('profile_landing_order_pdf', ['id' => $order->id]) }}" type="button" class="button_edit_profile btn btn-sm btn-rounded text-white me-auto m-2 mx-2">Detalle
                                            en PDF
                                        </a>
                                    </td>
                                </tr>
...
<div class="modal fade" id="editProfileLandingModal" tabindex="-1" aria-labelledby="editProfileLandingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('profile_landing_edit', ['id' => Auth::user()->id]) }}" enctype="multipart/form-data" id="updateForm">
                @csrf
