...
@section('content')
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 col-12">
                                        <input id="run" type="text"
                                            ...
                                            placeholder="RUN" autofocus maxlength="10" required oninput="checkRut(this)">
                                        @error('run')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2"
                                        style="color: white">Registrarse</button>
                                </div>
    ...
    <div class="modal fade" id="modal-terminos" tabindex="-1" aria-labelledby="editProfileLandingModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #8C034E;">
                    <h5 class="modal-title pt-3 pb-2" id="modal-terminos" style="color: white">Términos y Condiciones
                    </h5>
                </div>
                <div class="modal-body custom-modal-body">
                    <div class="three-fourths columns medium-down--one-whole offset-by-two is-hidden-offset-mobile-only page"
                        ...
                        <p class="terms_p">La experiencia de comprar en www.queguay.azurewebsites.net es fácil y segura. En
                            este sentido, la
                            empresa Vestuarios Que Guay trabaja con los más altos estándares de seguridad y toda la
                            información
                        ...
                        <p class="terms_p">Nuestros productos serán entregados a través de Chilexpress, Starken, BluExpress
                            o 99Minutos
                            dependiendo de la dirección de envío. El plazo de entrega en región metropolitana y en todo el
                            país es de
                            ...
                            del cliente
                            retirar el pedido antes de cumplidos 14 días en sucursal. De lo contrario el envío se devolverá
                            a nuestra
                        ...
                        <p>
                            <span class="terms_p">
                                ...
                                digitación de
                                la dirección de despacho. Se sugiere a todos los clientes corroborar los datos antes de
                                finalizar su
                                compra.
                            </span>
                        </p>
                        <p>
                            <span class="terms_p">
                                Toda Promoción de envío es exclusiva para productos marca Qye Guay! a no ser que se informe
                                lo contrario.
                            </span>
                        </p>
                        ...
                        <p class="terms_p">Para cumplir los objetivos de seguridad Gnomo cuenta con la tecnología SSL
                            (Secure Sockets
                            Layer) que asegura, tanto la autenticidad del Sitio, como el cifrado de toda la información que
                            nos entrega
                            el usuario. Cada vez que el usuario se registra en el Sitio y entrega información de carácter
                            personal,
                            sin importar el lugar geográfico en donde se encuentre, a efectos de comprar un producto, el
                            navegador por
                            el cual ejecuta el acto se conecta al Sitio a través del protocolo SSL que acredita que el
                            usuario se
                            encuentra efectivamente en el Sitio y en nuestros servidores (lo cual se aprecia con la
                            aparición del código
                            HTTPS en la barra de direcciones del navegador). De esta forma se establece un método de cifrado
                            de la
                            información entregada por el usuario y una clave de sesión única. Esta tecnología permite que la
                            información
                            de carácter personal del usuario, como su nombre, dirección y datos de tarjetas bancarias, sean
                            codificadas
                            antes para que no pueda ser leída cuando viaja a través de Internet. Todos los certificados SSL
                            se crean para
                        ...
                        <p class="terms_p">Vestuarios Que Guay no comunica ni cede a terceros, bajo ninguna circunstancia,
                            los datos
                            de carácter personal registrados por los usuarios en el Sitio. Sin perjuicio de lo anterior,
                            esta información
                            podrá ser tratada por Vestuarios Que Guay y sus asociados, únicamente para fines estadísticos
                            y/o para
                            obtener una mejor comprensión de los perfiles de los usuarios y, así, mejorar los productos
                            ofrecidos en el
                            Sitio.</p>
                        <br>
                        ...
                        <p class="terms_p">Al registrarse en el Sitio se le solicitará al usuario solamente aquella
                            ...
                            para el pago del producto y su posterior envío. En ningún caso, esta información será comunicada
                            o transmitida
                            a terceros ajenos a Vestuarios Que Guay, Que guay no almacena ni conserva la información de la
                            tarjeta
                        ...
                        <p class="terms_p">El usuario registrado podrá ejercer sus derechos de información, modificación,
                            eliminación,
                            cancelación y/o bloqueo de sus datos personales cuando lo estime pertinente, según lo
                            establecido en la Ley
                            Nº 19.628 sobre Protección de la Vida Privada. Vestuarios Que Guay pone a disposición del
                            usuario una
                            dirección de correo electrónico (contacto@queguay.cl), un número telefónico +569 57162265 a
                            disposición de
