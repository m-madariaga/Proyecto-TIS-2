                ...
                <div class="col-auto">
                    <div class="avatar avatar-xxl position-relative">
                        <img src="/argon/assets/img/images-profile/{{ Auth::user()->imagen }}" alt="profile_image"
                            id="profile_image" class="border-radius-lg shadow-sm img-thumbnail" style="width: 70%;">
                    </div>
                </div>
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <button class="btn btn-primary btn-sm ms-2 me-auto" data-bs-toggle="modal"
                                    data-bs-target="#editModal">Editar perfil</button>
                                <button type="button" class="btn btn-light btn-sm ms-2" data-bs-toggle="modal"
                                    data-bs-target="#editPasswordModal">Cambiar contraseña</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="edit-name" name="edit-name" value="{{ Auth::user()->name }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control input-field @error('run') is-invalid @enderror" id="edit-run"
                                        name="edit-run" value="{{ Auth::user()->run }}">
                                    @error('run')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone" class="form-control-label">Teléfono</label>
                                    <input type="text"
                                        class="form-control input-field @error('phone_number') is-invalid @enderror"
                                        id="edit-phone" name="edit-phone" value="{{ Auth::user()->phone_number }}">
                                    @error('phone_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="edit-email" name="edit-email" value="{{ Auth::user()->email }}">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="country" class="form-control-label">País</label>
                                    <select id="country"
                                        class="form-control form-select input-field @error('country_fk') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="region" class="form-control-label">Región</label>
                                    <select id="region"
                                        class="form-control form-select input-field @error('region_fk') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="city" class="form-control-label">Ciudad</label>
                                    <select id="city"
                                        class="form-control form-select input-field @error('city_fk') is-invalid @enderror"
