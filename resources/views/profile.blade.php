                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="country" class="form-label">País</label>
                                    <select id="country"
                                        class="form-select input-field @error('country_fk') is-invalid @enderror"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="region" class="form-label">Región</label>
                                    <select id="region"
                                        class="form-select input-field @error('region_fk') is-invalid @enderror"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="city" class="form-label">Ciudad</label>
                                    <select id="city"
                                        class="form-select input-field @error('city_fk') is-invalid @enderror"
