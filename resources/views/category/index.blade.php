    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <a href="{{ route('categorias-create') }}" class="btn btn-sm btn-outline-success mb-2"><i class="fa fa-plus"> Agregar categoria</i></a>
                        ...
                        <table id='tabla' class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{ route('categorias-edit', ['id' => $categoria->id]) }}">Editar Categoria</a>
                                        <form action="{{ route('categorias-destroy', ['id' => $categoria->id]) }}" class="formulario-eliminar" method="POST">
                                            @method('DELETE')
                                            @csrf
