...
function darkMode(el) {
  ...
  if (el.checked) {
    ...
    if (navbarBrandImg.includes('logo-ct-dark')) {
      var navbarBrandImgNew = navbarBrandImg.replace("logo-ct-dark", "logo-ct");
      navbarBrand.src = navbarBrandImgNew;
    }
    ...
    for (var i = 0; i < bg_gray_600.length; i++) {
      if (bg_gray_600[i].classList.contains('bg-gray-600')) {
        ...
        bg_gray_600[i].classList.add('bg-gray-300');
      }
    }
    for (var i = 0; i < btn_text_dark.length; i++) {
      if (btn_text_dark[i].classList.contains('text-dark')) {
        btn_text_dark[i].classList.remove('text-dark');
        btn_text_dark[i].classList.add('text-white');
      }
    }
    for (var i = 0; i < btn_text_white.length; i++) {
      if (btn_text_white[i].classList.contains('text-white')) {
        btn_text_white[i].classList.remove('text-white');
        btn_text_white[i].classList.add('text-dark');
      }
    }
    for (var i = 0; i < card_border.length; i++) {
      if (card_border[i].classList.contains('border')) {
    ...
    if (sidebar) {
      ...
      for (var i = 0; i < sidebarWhite.length; i++) {
        if (sidebarWhite[i].classList.contains('bg-white')) {
    ...
    for (var i = 0; i < svg.length; i++) {
      if (svg[i].classList.contains('text-dark')) {
        svg[i].classList.remove('text-dark');
    ...
    if (navbarBrandImg.includes('logo-ct')) {
      var navbarBrandImgNew = navbarBrandImg.replace("logo-ct", "logo-ct-dark");
      navbarBrand.src = navbarBrandImgNew;
    }
    for (var i = 0; i < cardNavLinksIcons.length; i++) {
    ...
    for (var i = 0; i < text_span_white.length; i++) {
      if (text_span_white[i].classList.contains('text-dark')) {
    ...
    for (var i = 0; i < text_strong_white.length; i++) {
      if (text_strong_white[i].classList.contains('text-dark')) {
    ...
    for (var i = 0; i < bg_gray_100.length; i++) {
      if (bg_gray_100[i].classList.contains('bg-gray-800')) {
        bg_gray_100[i].classList.remove('bg-gray-800');
        bg_gray_100[i].classList.add('bg-gray-100');
      }
    }
    for (var i = 0; i < bg_gray_600.length; i++) {
      if (bg_gray_600[i].classList.contains('bg-gray-300')) {
        bg_gray_600[i].classList.remove('bg-gray-300');
    ...
    for (var i = 0; i < btn_text_white.length; i++) {
      if (btn_text_white[i].classList.contains('text-dark')) {
    ...
    for (var i = 0; i < svg.length; i++) {
      if (svg[i].classList.contains('text-white')) {
        svg[i].classList.remove('text-white');
        svg[i].classList.add('text-dark');
      }
    }
